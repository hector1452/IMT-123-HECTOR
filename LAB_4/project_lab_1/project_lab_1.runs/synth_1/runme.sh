...
HD_PWD='C:/Users/hikar/Desktop/labdigxdxd/project_lab_1/project_lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_6.tcl
