...
HD_PWD='C:/Users/hikar/Desktop/LAB3PRUEBA/project_lab_1/project_lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_6.tcl -notrace
