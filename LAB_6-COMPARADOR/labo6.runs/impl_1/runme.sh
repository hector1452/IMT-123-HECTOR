...
HD_PWD='C:/Users/maxst/Desktop/Universidad/Sexto semestre/Digitales/labo6/labo6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log equal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source equal.tcl -notrace
