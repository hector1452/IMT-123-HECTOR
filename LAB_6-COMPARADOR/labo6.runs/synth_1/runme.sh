...
HD_PWD='C:/Users/maxst/Desktop/Universidad/Sexto semestre/Digitales/labo6/labo6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log equal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source equal.tcl
