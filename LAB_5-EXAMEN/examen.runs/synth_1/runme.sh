...
HD_PWD='C:/Users/maxst/Mult_4bit/Mult_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log module_adder_4BIT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source module_adder_4BIT.tcl
