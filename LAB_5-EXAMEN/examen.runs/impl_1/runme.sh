...
HD_PWD='C:/Users/maxst/Mult_4bit/Mult_4bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log module_adder_4BIT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source module_adder_4BIT.tcl -notrace
